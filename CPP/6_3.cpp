...
struct Student{
    ...
    bool isHonour(){
        bool math = (this->sessionResults.math == 5) ? true : false;
        bool physics = (this->sessionResults.physics == 5) ? true : false;
        bool history = (this->sessionResults.history == 5) ? true : false;
        bool chemistry = (this->sessionResults.chemistry == 5) ? true : false;
